        ...
        <main className="flex-1 flex flex-col">
          ...
          <div className="flex items-center gap-3 px-6 py-3 border-b border-white/10">
            ...
            <div className="ml-auto flex items-center gap-1.5 text-neutral-300">
              ...
              <button className={iconBtn} title="Bulleted list" aria-label="Bulleted list">
                <List size={18} />
              </button>
              <button className={iconBtn} title="Numbered list" aria-label="Numbered list">
                <ListOrdered size={18} />
              </button>
              <button className={iconBtn} title="Insert table" aria-label="Insert table">
                <Table size={18} />
              </button>
            ...
            <div className="flex items-center gap-1.5 pl-2 text-neutral-300">
              <button className={iconBtn} title="Add image" aria-label="Add image">
                <ImagePlus size={18} />
              </button>
